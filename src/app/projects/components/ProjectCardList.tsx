...
const data: Project[] = [
  {
    logo: '/saloon-5.png',
    title: "LogoS",
    description: "LogoS is a modern, gallery for showcasing logos with ease. Its responsive grid design, dynamic search, and seamless logo management make it perfect for displaying branding assets on any device.",
    techStack: ["Next Js", "Typescript", "Tailwind CSS", "Framer motion",],
    link: "https://logo-s.vercel.app/",
    source: "https://github.com/devxMani/LogoS",
  },
  {
    logo: '/credit-buddy.svg', //flick-ai.png
    title: "PixelBanana",
    description: "PixelBanana is a playful web app that brings your imagination to life through AI-powered image generation. It offers a fast, creative experience for transforming prompts into stunning visuals.",
    techStack: ["Next.js", "Typescript", "Hugging Face", "Difusional X API",],
    link: "https://pixel-banana.vercel.app/",
    source: "https://github.com/devxMani/PixelBanana",
  },
  {
    logo: '/token-2.png',
  ...
  {
    logo: "/memehub.png",// /chat-icon.png
    title: "Peeklink",
